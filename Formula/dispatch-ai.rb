class DispatchAi < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/dispatch-ai-labs/dispatch-ai/releases/download/v0.0.8/dispatch-darwin-arm64"
      sha256 "05f57176c1b02e2b27b34f21564137ca2e9c62111f23cda0890f17816dcf81f4"
    end
    on_intel do
      url "https://github.com/dispatch-ai-labs/dispatch-ai/releases/download/v0.0.8/dispatch-darwin-x64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/dispatch-ai-labs/dispatch-ai/releases/download/v0.0.8/dispatch-linux-arm64"
      sha256 "47cb62fa0d165586f8a754647a1b7e1beca303e064ad6d6f07e52f2796cf940a"
    end
    on_intel do
      url "https://github.com/dispatch-ai-labs/dispatch-ai/releases/download/v0.0.8/dispatch-linux-x64"
