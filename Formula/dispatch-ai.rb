class DispatchAi < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/dispatch-ai-labs/dispatch-ai/releases/download/v0.0.5/dispatch-darwin-arm64"
      sha256 "5571cd27e20bff0a49a9bc450c6988bf11085bd0ee78e80c44abcf2ac390f8ed"
    end
    on_intel do
      url "https://github.com/dispatch-ai-labs/dispatch-ai/releases/download/v0.0.5/dispatch-darwin-x64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/dispatch-ai-labs/dispatch-ai/releases/download/v0.0.5/dispatch-linux-arm64"
      sha256 "4c32a3b62038a6c85af3a6a92d837ae2fdfb9f93d43cb0a852273e28780c8b93"
    end
    on_intel do
      url "https://github.com/dispatch-ai-labs/dispatch-ai/releases/download/v0.0.5/dispatch-linux-x64"
